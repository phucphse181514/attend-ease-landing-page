...
const features = [
  {
    ...
    description: "Công nghệ nhận diện khuôn mặt AI hiện đại, chính xác và bảo mật cao",
  },
  {
    icon: DollarSign,
    title: "Tính lương tự động",
    description: "Tự động tính toán lương, thưởng, phụ cấp và các khoản khấu trừ",
  },
  {
    icon: UserPlus,
    title: "Quản lý tuyển dụng",
    description: "Hệ thống ATS giúp tối ưu hóa quy trình tuyển dụng nhân sự",
  },
  {
    icon: FileText,
    title: "Quản lý hợp đồng",
    description: "Số hóa và quản lý hợp đồng lao động, phụ lục một cách dễ dàng",
  },
  {
    icon: Users,
    title: "Quản lý nhân sự",
    description: "Quản lý toàn bộ thông tin nhân viên tập trung trên một nền tảng",
  },
  {
    icon: Clock,
    title: "Báo cáo thời gian thực",
    description: "Dashboard và báo cáo chi tiết giúp ra quyết định nhanh chóng",
  },
]
...
const jobs = [
  {
    ...
    type: "Full-time",
    salary: "25-35 triệu",
    description: "Tham gia phát triển giao diện người dùng cho hệ thống quản lý nhân sự AttendEase",
  ...
  },
  {
    ...
    type: "Full-time",
    salary: "20-30 triệu",
    description: "Xây dựng và tối ưu hóa API, database cho hệ thống HR toàn diện",
  ...
  },
  {
    ...
    type: "Full-time",
    salary: "30-40 triệu",
    description: "Phát triển và cải thiện thuật toán nhận diện khuôn mặt và các tính năng AI",
  ...
  },
  {
    ...
    type: "Full-time",
    salary: "25-35 triệu",
    description: "Định hướng phát triển sản phẩm, làm việc với đội ngũ kỹ thuật và khách hàng",
  ...
  },
  {
    ...
    type: "Full-time",
    salary: "18-25 triệu",
    description: "Thiết kế trải nghiệm người dùng trực quan và hiện đại cho hệ thống HR",
  ...
  },
  {
    ...
    description: "Tư vấn và bán giải pháp quản lý nhân sự cho doanh nghiệp vừa và lớn",
    ...
    <div className="min-h-screen">
      ...
      {activeTab === "home" && (
        <>
              ...
              <div className="grid items-center gap-12 lg:grid-cols-2">
                <div>
                  ...
                  <p className="mb-8 text-pretty text-lg text-muted-foreground">
                    Nền tảng quản lý nhân sự hiện đại với công nghệ AI, giúp doanh nghiệp tối ưu hóa quy trình chấm
                    công, tính lương, tuyển dụng và quản lý hợp đồng
                  </p>
                  <div className="flex flex-wrap gap-4">
                    <Button size="lg" className="bg-primary text-lg hover:bg-primary/90">
                  ...
                  <div className="mt-12 grid grid-cols-2 gap-6 sm:grid-cols-4">
                    {stats.map((stat, index) => (
                      <div key={index}>
                        <div className="mb-1 text-2xl font-bold text-primary">{stat.number}</div>
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-muted-foreground">99.9% chính xác</div>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
                    <Card className="absolute -right-6 bottom-1/4 z-20 w-48 shadow-lg">
                      <CardContent className="p-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="text-sm font-medium">Tăng trưởng</div>
                            <div className="text-xs text-muted-foreground">+45% hiệu suất</div>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
            ...
            <div className="container mx-auto px-4">
              <div className="mb-16 text-center">
                ...
                <p className="mx-auto max-w-2xl text-pretty text-lg text-muted-foreground">
                  AttendEase cung cấp đầy đủ các công cụ cần thiết để quản lý nhân sự hiệu quả
                </p>
              </div>
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {/* Large feature card */}
                <Card className="group md:col-span-2 lg:row-span-2">
                  <CardContent className="flex h-full flex-col justify-between p-8">
                    <div>
                      ...
                      <h3 className="mb-3 text-2xl font-bold">Chấm công khuôn mặt AI</h3>
                      <p className="mb-6 text-muted-foreground">
                        Công nghệ nhận diện khuôn mặt tiên tiến với độ chính xác 99.9%, chống gian lận và bảo mật tuyệt
                        đối
                      </p>
                    ...
                    <div className="mt-6">
                      <img src="/facial-recognition-attendance-system-scanning-face.jpg" alt="Facial Recognition" className="rounded-lg" />
                    </div>
                  </CardContent>
                </Card>
            ...
            <div className="container mx-auto px-4">
              <div className="grid items-center gap-12 lg:grid-cols-2">
                ...
                <div className="order-2 lg:order-1">
                  <div className="relative">
                    <img src="/professional-business-team-working-office-modern.jpg" alt="Professional Team" className="rounded-2xl shadow-xl" />
                ...
                <div className="order-1 lg:order-2">
                  ...
                  <p className="mb-8 text-muted-foreground">
                    Chúng tôi mang đến giải pháp quản lý nhân sự toàn diện, giúp doanh nghiệp tối ưu hóa quy trình và
          ...
          {/* CTA Section */}
          <section className="border-y bg-gradient-to-br from-primary/10 via-accent/5 to-background py-20">
            <div className="container mx-auto px-4">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="mb-8 text-pretty text-lg text-muted-foreground">
                  Hãy để AttendEase giúp doanh nghiệp của bạn tối ưu hóa quy trình và nâng cao hiệu suất làm việc
                </p>
                <Button size="lg" className="bg-primary text-lg hover:bg-primary/90">
            ...
            <div className="container mx-auto px-4">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="text-pretty text-lg text-muted-foreground">
                  Chúng tôi đang tìm kiếm những tài năng xuất sắc để cùng xây dựng tương lai của quản lý nhân sự
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="container mx-auto px-4">
              <div className="mx-auto max-w-6xl">
                <div className="mb-12 grid gap-6 md:grid-cols-3">
                  ...
                  <Card>
                    <CardContent className="p-6 text-center">
                      ...
                      <div className="text-sm text-muted-foreground">Vị trí đang tuyển</div>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="p-6 text-center">
                ...
                <div className="space-y-6">
                  {jobs.map((job) => (
                    <Card key={job.id} className="group transition-all hover:shadow-lg hover:shadow-primary/10">
                      <CardContent className="p-6">
                  ...
                  <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-accent/5">
                    <CardContent className="p-8 md:p-12">
                      <div className="mb-8 text-center">
                        <h3 className="mb-2 text-2xl font-bold md:text-3xl">Tại sao nên làm việc tại AttendEase?</h3>
                        <p className="text-muted-foreground">
                          Môi trường làm việc chuyên nghiệp và nhiều cơ hội phát triển
                        </p>
                      </div>
                      ...
                      <div className="mt-8">
                        <img src="/modern-office-workspace-team-collaboration-happy-e.jpg" alt="Team working" className="rounded-xl" />
                      </div>
                    </CardContent>
                  </Card>
                </div>
